...
exports.userRouter.get("/metadata/bulk", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userIds = userIdString.slice(1, (userIdString === null || userIdString === void 0 ? void 0 : userIdString.length) - 2).split(",");
    const metadatas = yield client_1.default.user.findMany({
        where: {
            id: {
                in: userIds,
            }
    ...
    res.json({
        avatars: metadatas.map((m) => {
            ...
            return ({
                userId: m.id,
                avatar: (_a = m.avatar) === null || _a === void 0 ? void 0 : _a.imageUrl,
            });
        }),
    });
}));
